...
#remapped_df = "/home/pelmo/data_and_pipelines/sscrofa_variant_remapping/data/final_files/remapped_and_verified_vars.csv"
#input_vcf = "/home/pelmo/data_and_pipelines/sscrofa_variant_remapping/data/vcf_files/whole_POP_all.vcf"
df = pd.read_csv(input_vcf, sep = "\t", comment = '#', header = None)
remapped_df = pd.read_csv(remapped_df)
remapped_df = remapped_df[['gene_name_10', 'ensembl_id_10', 'ensembl_id_11', 'chr_11_ensembl', 'strand_11', 'gene_start_11', 'gene_end_11', 'rel_var_pos_10', 'rel_var_pos_11', 'var_pos_11']].reset_index(drop=True)
...
merged['header'] = merged['gene_name_10'] +"|"+ merged['ensembl_id_11'] +"|"+ merged['chr_11_ensembl'].astype(str) +"|"+ merged['gene_start_11'].astype(str) +"|"+ merged['gene_end_11'].astype(str) + "|" + merged['var_pos_11'].astype(str)
