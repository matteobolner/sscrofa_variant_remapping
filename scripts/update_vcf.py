...
remapped_df = remapped_df[['gene_name_11', 'ensembl_id_10', 'ensembl_id_11', 'chr_11_ensembl', 'strand_11', 'gene_start_11', 'gene_end_11', 'rel_var_pos_10', 'rel_var_pos_11', 'var_pos_11']].reset_index()
