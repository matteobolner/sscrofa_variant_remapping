...
from rest_functions import get_genes_info_v11

remapped_ids= snakemake.input[0]
merged_file = snakemake.input[1]
#remapped_ids = '/home/pelmo/sscrofa_variant_remapping/data/starting_files/remapped_ids.csv'
#merged_file = '/home/pelmo/sscrofa_variant_remapping/data/complete_coords/merged_coords.csv'
...
remapped_df['updated_id'].tolist()
genes_info_v11_df = get_genes_info_v11(ensembl_ids_v11)
