...
#import custom Ensembl REST client
...
#get tue ensembl stable IDS and query Ensembl through the client to get their information
...
#get the absolute position of the variants, based on the gene strand
